...
import { RawIntlProvider, createIntl, createIntlCache } from '/Users/richard/Documents/work/G2/site/node_modules/.pnpm/react-intl@7.1.11_react@19.1.0_typescript@4.9.5/node_modules/react-intl';
import { useIsomorphicLayoutEffect } from '/Users/richard/Documents/work/G2/site/node_modules/.pnpm/dumi@2.4.17_@babel+core@7.28.0_@swc+helpers@0.5.1_@types+node@24.1.0_@types+react@19.1._ebae42d2791f93a51895ccc3fa68101f/node_modules/dumi/dist/client/theme-api/utils.js'
...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    ...
    localeMessages['$internal.edit.link'] = "https://github.com/antvis/g2/edit/v5/{filename}";

    localeMessages['$internal.api.sourceLink'] = "https://github.com/antvis/g2/tree/v5/{fileName}#L{line}";
